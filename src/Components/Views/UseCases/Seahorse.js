    ...
    <div className="container mb-16 mx-auto">
      <div>
        <div className="flex flex-col mt-12 mb-16 items-center justify-center">
          <h1 className="text-center mb-6 text-4xl font-bold">Seahorse on the seabed</h1>
          ...
          <div className="mb-10">
            ...
            <p className="text-base w-3/5  mx-auto mt-10 w-full md:-mt-0 lg:w-3/4 leading-8 text-gray-700  text-left">
