...
function Blogger(){
    return(
      ...
      <div className="w-full flex flex-wrap mx-20 justify-center  p-10">
        <div className="w-full mt-10 p-5 text-cyan-900  bg-cyan-50">
          <div>
            <h1 className="mx-12 text-xl font-semibold">Blogger</h1>
          </div>
          <div>
 ...
 <div className="w-3/4  h-96 mt-10 mx-auto">
                <img src="../assets/images/project_images/blogger_screenshot_01.png"/></div>
            <div>
