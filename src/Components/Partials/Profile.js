        ...
        <div className="w-3/5  bg-red-50 ">
            <div className="relative w-40 h-40 mt-20 mx-auto rounded-full bg-red-200">
                <div className="absolute top-1/2 left-1/2  -translate-y-1/2 text-center">
                    <h1 className="animate-fade-in-right absolute -top-24 transform  left-20 translate-y-1/5 font-bold text-red-800 text-xl w-full text-cyan-900" >I'm</h1>
                    <h3 className="animate-fade-in-right absolute animate-text top-0 -left-1/3 transform -translate-x-1/5 -translate-y-1/2 font-bold text-red-800 text-3xl">Front end Developer</h3>
                </div>
            </div> 
        </div>
